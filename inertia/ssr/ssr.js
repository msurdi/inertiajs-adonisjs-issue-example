...
var HomeIndex = function HomeIndex() {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Hello worl");
};
...
var map = {
	"./Home/Index": "./resources/js/Pages/Home/Index.jsx",
	"./Home/Index.jsx": "./resources/js/Pages/Home/Index.jsx"
};
...
var render = function render(page) {
  return (0,_inertiajs_react__WEBPACK_IMPORTED_MODULE_1__.createInertiaApp)({
    page: page,
    render: (react_dom_server__WEBPACK_IMPORTED_MODULE_2___default().renderToString),
